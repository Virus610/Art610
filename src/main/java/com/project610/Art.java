...
public class Art extends Application implements EventHandler<ActionEvent> {
    ...
    public void start(Stage stage) throws Exception {
        ...
        pane.setBackground(new Background(new BackgroundFill(new Color(.4, .4, .6, 1.0), null, null)));
